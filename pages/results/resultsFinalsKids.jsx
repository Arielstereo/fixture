...
const ResultFinalsKids = ({ results }) => {
  return (
    <Layout>
      <div className="p-8">
        <h1 className="text-sky-400 text-3xl md:text-6xl text-center font-bold mt-32 mb-8">
          Pronósticos Final y tercer puesto <span className="text-yellow-400">Kids</span>
        </h1>
                  ...
                  >
                    <Table className="w-full">
                      ...
                      <Table.Body>
                        <Table.Row>
                          <Table.Cell>
                            <span className="text-xs md:text-lg">arg-fra</span>
                          </Table.Cell>
                          <Table.Cell>
                        ...
                        <Table.Row>
                          <Table.Cell>
                            <span className="text-xs md:text-lg">cro-mar</span>
                          </Table.Cell>
                          <Table.Cell>
                            <span className="text-green-700 text-xs md:text-lg">
                              {item.checked2}
...
export default ResultFinalsKids;
