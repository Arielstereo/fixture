                  ...
                  >
                    <Table className="w-full">
                      ...
                      <Table.Body>
                        <Table.Row>
                          <Table.Cell>
                            <span className="text-xs md:text-lg">bra-cro</span>
                          </Table.Cell>
                          <Table.Cell>
                        ...
                        <Table.Row>
                          <Table.Cell>
                            <span className="text-xs md:text-lg">arg-hol</span>
                          </Table.Cell>
                          <Table.Cell>
                            <span className="text-green-700 text-xs md:text-lg">
                              {item.checked2}
                        ...
                        <Table.Row>
                          <Table.Cell>
                            <span className="text-xs md:text-lg">fra-ing </span>
                          </Table.Cell>
                          <Table.Cell>
                            <span className="text-green-700 text-xs md:text-lg">
                              {item.checked3}
                        ...
                        <Table.Row>
                          <Table.Cell>
                            <span className="text-xs md:text-lg">mar-por</span>
                          </Table.Cell>
                          <Table.Cell>
                            <span className="text-green-700 text-xs md:text-lg">
                              {item.checked4}
...
export default ResultCuartosKids;
