    ...
    <Layout>
        ...
        >
          ...
          <Modal.Body>
            <Text id="modal-description">
              En la primera fase cada acierto vale 1 punto. A partir de octavos
              de final cada acierto vale 3 puntos. En cuartos de final 5 puntos.
              En semifinales 8 puntos. Tercer puesto 10 puntos. Final 15 puntos.
              El resultado se toma en cuenta dentro de los 90 minutos de juego,
              no cuenta el resultado de la prórroga y/o penales. Antes de
              iniciar el torneo cada participante deberá elegir el podio:
              campeón, subcampeón y el ganador del tercer puesto. Puntajes:
              Campeón 30 puntos, subcampeón 20 y tercero 10.
            </Text>
          </Modal.Body>
          <Modal.Footer>
            <Button
      ...
      <div className="divide-y-2 mx-8">
        <div className="flex flex-col lg:flex-row lg:gap-16 justify-center items-center my-4">
          <div className="w-[400px] md:w-[600px] rounded-3xl">
            <div>
              <h1 className="flex items-center  justify-center text-white text-4xl text-center py-2 font-bold">
                Torneo Tredi Argentina <Image src="/trofeo.png" alt="trofeo" width="100" height="100"/>
              </h1>
            </div>
          ...
          <div className="w-[400px] md:w-[600px] rounded-3xl">
            <div>
            <h1 className="flex items-center  justify-center text-white text-4xl text-center py-2 font-bold">
                Torneo Kids <Image src="/trofeo.png" alt="trofeo" width="100" height="100"/>
              </h1>
            </div>
        ...
        <div className="flex flex-col gap-4 text-center my-16">
          ...
          <span className="text-white font-semibold text-base mx-8 mt-6">
            * En caso de empate en algún puesto se definirá el ganador primero
            ...
            cuenta que participante de su familia obtuvo más puntos en el otro
            torneo. Sino se realizará un sorteo.
          </span>
        </div>
      </div>
    </Layout>
