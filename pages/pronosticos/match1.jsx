...
export default function Match1() {
  ...
  const data = async (result) => {
    const res = await fetch("/api/match1", {
      method: "POST",
      headers: {
      ...
      <div className="flex flex-col items-center px-10">
        ...
        <div className="mx-8 md:mx-36 lg:mx-32 mb-8">
          ...
          <Input
            ...
            <button className="text-gray-800 font-semibold bg-yellow-400 hover:bg-transparent hover:text-white border-2 border-white py-2 px-32 rounded-lg mx-12 mt-6">
              Enviar
            </button>
          </form>
        </div>
